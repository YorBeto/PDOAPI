    ...
    public function historial(){
        ...
        $dataObject = json_decode($input);
            ...
            $todoelhistorial=$historial->query("SELECT PRODUCTOS_SERVICIOS.NOMBRE AS PRODUCTO, PRODUCTOS_SERVICIOS.PRECIO,DETALLE_VENTA.CANTIDAD, ORDEN_VENTA.FECHA_ORDEN AS FECHA,
                PRODUCTOS_SERVICIOS.IMAGEN,DETALLE_VENTA.ESTADO_ENTREGA AS ESTADO FROM PAGOS JOIN ORDEN_VENTA ON PAGOS.ID_ORDEN = ORDEN_VENTA.ID_ORDEN JOIN CLIENTES ON ORDEN_VENTA.ID_CLIENTE = CLIENTES.ID_CLIENTES
